...
Table~\ref{tab:smoke} reports three-sample validation subset tests. These are not final benchmark results; they primarily prove that the API, dataset loader, scoring logic, and workflows are connected correctly. The subset uses sample seed 1 and indices [17,72,108] for MATH and [4,8,16] for HumanEval.
...
\begin{enumerate}
    ...
    \item Add ablations: remove ensemble, remove public-test repair, reduce candidate count, and compare non-thinking against thinking-enabled Kimi K2.5.
\end{enumerate}
