...
| `experiments/finalize_submission.py ...` | Builds and verifies a filled-metadata zip/PDF, then restores local `report/main.tex` and `report/main.pdf` placeholders unless `--keep-filled-report` is passed |
